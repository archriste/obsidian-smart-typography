  ...
  display(): void {
    ...
    new Setting(containerEl)
      ...
      new Setting(containerEl)
        ...
        .setDesc(
          "R^2 will be converted to R². Supports UTF-8 superscripts for numbers 0-9, +, -, =, (, ), and 'n'. Can auto-pair brackets."
        )
        .addToggle((toggle) => {
          toggle
        ...
        new Setting(containerEl)
          .setName("Subscripts")
          .setDesc(
            "H_2 will be converted to H₂. Supported UTF-8 subscripts for numbers 0-9, +, -, =, (, ), and 'n'. Can auto-pair brackets."
          )
          .addToggle((toggle) => {
            toggle
